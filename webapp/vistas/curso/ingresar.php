...
if(isset($_POST['button_submit']))
{
    ...
    $id = BDD::INSERTAR_DESDE_ARRAY("curso",$array);
    if($id){
...
<html>
	<head>
		<title>Formulario de Registro Curso</title>
...
<div class="col-md-6">
		...
		<form role="form" name="registro" id="form_usuario" method="post">
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="username" name="nivel" placeholder="nivel">
		  </div>
            <div class="form-group">
                <label for="username">Paralelo</label>
                <input type="text" class="form-control" id="username" name="paralelo" placeholder="Paralelo">
            </div>
