...
if(isset($_POST['button_submit']))
{
    ...
    $id = BDD::ELIMINAR_DATOS("curso","idcurso = $id");
    if($id){
        header("location: ../admin/");
    }else{
        ...
        <div class="col-md-6">
            ...
            <form role="form" name="registro" id="form_usuario" method="post">
                <div class="form-group">
                    <label for="username">ESTAS SEGURO DE ELIMINAR ESTO?</label>
                    <input type="text" class="form-control" id="username" value="<?php echo $datos['nivel']?>" disabled name="nivel" placeholder="nivel">
                </div>
                <div class="form-group">
                    <label for="username">Paralelo</label>
                    <input type="text" class="form-control" id="username"value="<?php echo $datos['paralelo']; ?>" disabled name="paralelo" placeholder="Paralelo">
                </div>
