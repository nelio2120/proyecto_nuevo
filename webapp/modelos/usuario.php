<?php
  ...
  class Usuario extends Conexion
  {
      ...
      */
      ...
      if($verificar_usuario > 0){
        ...
        */
        ...
        if($_SESSION['rol'] == 2){
          echo '../vistas/estudiante/estudiante_index.php';
        }else if($_SESSION['rol'] == 3){
          echo '../vistas/profesor/profesor_index.php';
        }
    ...
    public function registroUsuario($nombre, $usuario_e, $clave)
    {
      parent::conectar();

      $nombre  = parent::filtrar($nombre);
      $usuario_e = parent::filtrar($usuario_e);
      $clave = parent::filtrar($clave);


      // validar que el correo no exito
      $verificarCorreo = parent::verificarRegistros('select id_usuario from usuario where usuario="'.$usuario_e.'" ');
      ...
      if($verificarCorreo > 0){
        ...
        parent::query('insert into usuarios(nombre, email, clave, cargo) values("'.$nombre.'", "'.$usuario_e.'", MD5("'.$clave.'"), 2)');
